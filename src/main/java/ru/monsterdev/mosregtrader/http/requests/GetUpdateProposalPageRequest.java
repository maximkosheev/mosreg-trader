...
public class GetUpdateProposalPageRequest extends TraderRequest {
    private static final String URL = "https://market.mosreg.ru/Application/EditPrice?applicationId=%d";

    private HttpGet request;

    public GetUpdateProposalPageRequest(Long proposalId) {
        request = new HttpGet(String.format(URL, proposalId));
        ...
        request.setHeader("Referer", String.format(URL, proposalId));
