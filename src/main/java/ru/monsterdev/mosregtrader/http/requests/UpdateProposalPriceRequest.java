...
public class UpdateProposalPriceRequest extends TraderRequest {
  ...
  public UpdateProposalPriceRequest(Trade trade) {
    ...
    proposalEditPriceDto.setProducts(trade.getProposal().getProducts().stream().map(proposalProduct -> {
      ...
      product.setOkeiCode(proposalProduct.getOkeiCode());
      product.setOkeiDescription(proposalProduct.getOkeiDescription());
      product.setClassificatorCode(proposalProduct.getClassificatorCode());
      product.setClassificatorDescription(proposalProduct.getClassificatorDescription());
      product.setClassificatorType(proposalProduct.getClassificatorType());
      product.setQuantity(proposalProduct.getQuantity());
      product.setName(proposalProduct.getName());
      product.setPositionNumber(proposalProduct.getPositionNumber());
      product.setPrice(proposalProduct.getPrice());
      product.setExternalId(proposalProduct.getExternalId());
      return product;
